...
class BusTypeListPageClass
{
    ...
    /**
     * Reorder bus submenu to keep "Bus Types" as 3rd item (index 2)
     */
                    ...
                    <form method="get" action="<?php echo admin_url('edit.php'); ?>" id="shuttle-list-filter-form">
                        ...
                        <div class="filters-row">
                            <div class="filter-left" style="flex-grow:initial">
                                ...
                                <?php if ($s) : ?>
                                    <a href="<?php echo admin_url('edit.php?post_type=wbbm_bus&page=wbbm-bus-type-list'); ?>" class="btn btn-outline btn-sm" style="text-decoration:none;">
                        ...
                        <tbody>
                            <?php if (!empty($terms) && !is_wp_error($terms)) : ?>
                                <?php foreach ($terms as $term) :
                                    $edit_url = admin_url('edit.php?post_type=wbbm_bus&page=wbbm-bus-type-edit&term_id=' . $term->term_id);
