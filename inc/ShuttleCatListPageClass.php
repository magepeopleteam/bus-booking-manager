...
class ShuttleCatListPageClass
{
    ...
    private function is_module_request()
    {
        if (class_exists('WBBM_Admin_Hub')) {
            return WBBM_Admin_Hub::is_module_screen('wbbm-shuttle-cat-list', 'wbbm-shuttle-manager', 'categories', false);
        }

        // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Screen check only.
        return isset($_GET['page']) && 'wbbm-shuttle-cat-list' === sanitize_key(wp_unslash($_GET['page']));
    }
