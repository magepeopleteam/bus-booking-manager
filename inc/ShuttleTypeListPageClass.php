...
class ShuttleTypeListPageClass
{
    ...
    private function is_module_request()
    {
        if (class_exists('WBBM_Admin_Hub')) {
            return WBBM_Admin_Hub::is_module_screen('wbbm-shuttle-type-list', 'wbbm-shuttle-manager', 'types', false);
        }

        // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Screen check only.
        return isset($_GET['page']) && 'wbbm-shuttle-type-list' === sanitize_key(wp_unslash($_GET['page']));
    }
