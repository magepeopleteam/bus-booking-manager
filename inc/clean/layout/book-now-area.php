...
function mage_book_now_area($available_seat = null){
    ...
    $boarding_time = sanitize_text_field(wbbm_get_datetime(boarding_dropping_time(false, false), 'time'));
        ...
        <div class="mage_flex_equal">
            <div class="mage_sub_price">
                <div class="mage_sub_total"> 
                    <div> 
                        <?php echo esc_html( wbbm_get_option('wbbm_sub_total_text', 'wbbm_label_setting_sec', __('Sub Total', 'bus-booking-manager')) ); echo esc_html(':'); ?> 
                    </div> 
