    ...
    <div class="mage_flex mage_book_now_area">
        ...
        <div class="mage_flex_equal">
            <div class="mage_sub_price">
                <p class="mage_sub_total"><?php echo wbbm_get_option('wbbm_sub_total_text', 'wbbm_label_setting_sec',__('Sub Total :', 'bus-booking-manager')); ?><strong><span><?php echo wc_price(0); ?></span></strong></p>
            </div>
