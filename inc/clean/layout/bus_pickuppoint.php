                                            ...
                                            if ($get_pickpoints_data) {
                                                ...
                                                foreach ($get_pickpoints_data as $pickpoint) : ?>
                                                    ...
                                                    <div class="pickpoint-adding">
                                                        ...
                                                        <span class="wbbm_bus_route_icon wbbm_bus_route_icon1">
                                                        <img src="<?php echo esc_url( WBTM_PLUGIN_URL . 'images/bus_route_map.png' ); ?>" /></span>
                                                        ...
                                                        <?php
                                                                if ($bus_pickpoints) {
                                                                    foreach ($bus_pickpoints as $bus_pickpoint) {
                                                                        echo '<option value="' . esc_attr( $bus_pickpoint->name ) . '" ' . selected( $bus_pickpoint->name, $pickpoint['pickpoint'], false ) . '>' . esc_html( $bus_pickpoint->name ) . '</option>';
                                                                    }
                                                                }
                                                                ?>
