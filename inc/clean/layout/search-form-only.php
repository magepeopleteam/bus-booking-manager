...
?>
    <form action="<?php echo $single_bus ? '' : get_site_url() .'/'. $target.'/'; ?>" method="get" class="mage_form">
        <div class="mage_form_list">
            ...
            <div class="mage_input_select">
                <input id="bus_start_route" type="text" class="mage_form_control" name="bus_start_route" value="<?php echo mage_get_isset('bus_start_route'); ?>" placeholder="<?php _e('Please Select', 'bus-booking-manager'); ?>" autocomplete="off" required/>
                <?php
                if($single_bus){
        ...
        <div class="mage_form_list">
            ...
            <div class="mage_input_select">
                <input id="bus_end_route" type="text" class="mage_form_control" name="bus_end_route" value="<?php echo mage_get_isset('bus_end_route'); ?>" placeholder="<?php _e('Please Select', 'bus-booking-manager'); ?>" autocomplete="off" required/>
                <?php
                if($single_bus){
        ...
        <div class="mage_form_list">
            ...
            <input type="text" class="mage_form_control" id="j_date" name="j_date" value="<?php echo mage_get_isset('j_date'); ?>" placeholder="YYYY-MM-DD" autocomplete="off" required>
        </div>
        <?php if (!$single_bus) {
            ...
            <div class="mage_form_list mage_return_date <?php echo $return ? '' : 'mage_hidden' ?>">
                ...
                <input type="text" class="mage_form_control" id="r_date" name="r_date" value="<?php echo mage_get_isset('r_date'); ?>" autocomplete="off" placeholder="YYYY-MM-DD">
            </div>
        <?php } ?>
        <div class="mage_form_list">
