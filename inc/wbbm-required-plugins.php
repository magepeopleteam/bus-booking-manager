...
class WBBM_Required_Plugins {
    ...
    public function wbbm_chk_plugin_folder_exist( $slug ) {
        $plugin_dir = ABSPATH . 'wp-content/plugins/' . sanitize_text_field( $slug );
        return is_dir( $plugin_dir );
    }

    public function wbbm_plugin_activate() {
        if ( isset( $_GET['wbbm_plugin_activate'] ) && ! is_plugin_active( sanitize_text_field( $_GET['wbbm_plugin_activate'] ) ) ) {
            $slug = sanitize_text_field( $_GET['wbbm_plugin_activate'] );
    ...
    public function wbbm_mpdf_plugin_install() {
        ...
        if ( isset( $_GET['wbbm_plugin_install'] ) && ! $this->wbbm_chk_plugin_folder_exist( sanitize_text_field( $_GET['wbbm_plugin_install'] ) ) ) {
            $slug = sanitize_text_field( $_GET['wbbm_plugin_install'] );
    ...
    public function wbbm_plugin_page() {
        ...
        // WooCommerce
        if ( ! $this->wbbm_chk_plugin_folder_exist( 'woocommerce' ) ) {
        ...
        } elseif ( $this->wbbm_chk_plugin_folder_exist( 'woocommerce' ) && ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
        ...
        } elseif ( $this->wbbm_chk_plugin_folder_exist( 'bus-booking-manager' ) && ! is_plugin_active( 'bus-booking-manager/woocommerce-bus.php' ) ) {
    ...
    <td><?php echo wp_kses_post($button_wc); ?></td>
</tr>
...
<tr>
    ...
    public function wbbm_inactive_plugin_list() {
        ...
        if ( $this->wbbm_chk_plugin_folder_exist( 'woocommerce' ) && ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
            $list[] = esc_html__( 'WooCommerce', 'bus-booking-manager' );
        }
