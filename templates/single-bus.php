            ...
            <div class="mage_flex_equal xs_not_flex">
                ...
                <div class="mage_bus_details">
                    <div class="mage_bus_info">
						...
						<?php } ?>
                        <p>
                            <strong><?php echo wbbm_get_option('wbbm_bus_no_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_bus_no_text', 'wbbm_label_setting_sec') : _e('Bus No', 'bus-booking-manager');
									echo ':'; ?></strong>
							<?php echo get_post_meta(get_the_id(), 'wbbm_bus_no', true); ?>
                        </p>
						<?php if (($seat_price_adult > 0 || $is_price_zero_allow == 'on') && $odd_list && !$off_day) { ?>
                            <p>
                                <strong><?php echo wbbm_get_option('wbbm_boarding_points_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_boarding_points_text', 'wbbm_label_setting_sec') : _e('Boarding', 'bus-booking-manager');
										echo ':'; ?></strong>
								<?php echo $boarding; ?>
                                <strong>(<?php echo $boarding_time; ?>)</strong>
                            </p>
                            <p>
                                <strong><?php echo wbbm_get_option('wbbm_dropping_points_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_dropping_points_text', 'wbbm_label_setting_sec') : _e('Dropping', 'bus-booking-manager');
										echo ':'; ?></strong>
								<?php echo $dropping; ?>
						...
						<?php } ?>
                        <p>
                            <strong><?php echo wbbm_get_option('wbbm_total_seat_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_total_seat_text', 'wbbm_label_setting_sec') : _e('Total Seat', 'bus-booking-manager');
									echo ':'; ?></strong>
						...
						<?php if (($seat_price_adult > 0 || $is_price_zero_allow == 'on') && $odd_list && !$off_day && ($off_date_status == false)) { ?>
							<?php if ($is_sell_off != 'on') : ?>
								<?php if ($seat_available && $seat_available == 'on') : ?>
                                    <p>
										...
										<?php echo wbbm_get_option('wbbm_seats_available_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_seats_available_text', 'wbbm_label_setting_sec') : _e('Seat Available', 'bus-booking-manager');
											echo ':'; ?>
                                    </p>
								<?php endif; ?>
							<?php endif; ?>
							...
							$is_price_zero_allow = get_post_meta($id, 'wbbm_price_zero_allow', true);
							?>
                            <p><strong><?php echo wbbm_get_option('wbbm_fare_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_fare_text', 'wbbm_label_setting_sec') : _e('Fare', 'bus-booking-manager');
										echo ':'; ?></strong></p>
                            <input type="hidden" name="available_quantity" value="<?php echo $available_seat ?>">
                            <div class="mage_center_space mar_b">
                                <div>
                                    <p>
                                        <strong><?php echo wbbm_get_option('wbbm_adult_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_adult_text', 'wbbm_label_setting_sec') : _e('Adult', 'bus-booking-manager');
												echo ':'; ?></strong>
							...
							if (($seat_price_child > 0) || ($is_price_zero_allow == 'on')) : ?>
                                <div class="mage_center_space mar_b">
                                    <p>
                                        <strong><?php echo wbbm_get_option('wbbm_child_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_child_text', 'wbbm_label_setting_sec') : _e('Child', 'bus-booking-manager');
												echo ':'; ?></strong>
							...
							<?php if (($seat_price_infant > 0) || ($is_price_zero_allow == 'on')) : ?>
                                <div class="mage_center_space mar_b">
                                    <p>
                                        <strong><?php echo wbbm_get_option('wbbm_infant_text', 'wbbm_label_setting_sec') ? wbbm_get_option('wbbm_infant_text', 'wbbm_label_setting_sec') : _e('Infant', 'bus-booking-manager');
												echo ':'; ?></strong>
